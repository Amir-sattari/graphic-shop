                            ...
                            @foreach($products as $product)
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      @csrf
                                      @method('delete')
                                        <button class="btn btn-default btn-icons" onclick="return confirm('Are you sure you want to delete this product?\n{{$product->title}}')" type="submit"><i class="fa fa-trash"></i></button>
                                      </form>
                                  </td> 
                              </tr>
                            @endforeach
