    ...
    <header class="header-v4">
            ...
            <div class="wrap-menu-desktop how-shadow1">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="۲">
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="{{ route('home.products.all') }}"><img src="/images/icons/logo-01.png" alt="IMG-LOGO"></a>
            </div>
            ...
            <div class="wrap-icon-header flex-w flex-r-m m-l-15">
                ...
                <div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart" data-notify="{{ count(json_decode(Cookie::get('basket'), true)) }}">
                    <i class="zmdi zmdi-shopping-cart"></i>
                </div>
            ...
            <div class="header-cart-content flex-w js-pscroll">
                <ul class="header-cart-wrapitem w-full">
                    ...
                    <li class="header-cart-item flex-w flex-t m-b-12">
                        <a href="{{ route('home.basket.delete',$id) }}">
                ...
                <div class="w-full">
                    ...
                    <div class="header-cart-buttons flex-w w-full">
                        <a href="{{ route('home.checkout.show') }}" class="flex-c-m stext-101 cl0 size-107 w-100 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-l-8 m-b-10">
